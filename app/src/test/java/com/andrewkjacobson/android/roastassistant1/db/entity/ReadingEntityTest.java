...
//        super.setUp();
//        reading = new ReadingEntity(3,100,75);
//    }
//
//    public void testGetSeconds() {
//        assertEquals(3, reading.getSeconds());
//        ReadingEntity r = new ReadingEntity(-1,100,75);
//        assertEquals(-1, r.getSeconds());
//        r = new ReadingEntity(0,100,75);
...
//        ReadingEntity r = new ReadingEntity(-1,-1,75);
//        assertEquals(-1, r.getTemperature());
//        r = new ReadingEntity(0,0,75);
...
//        ReadingEntity r = new ReadingEntity(-1,100,-1);
//        assertEquals(-1, r.getPower());
//        r = new ReadingEntity(0,100,0);
